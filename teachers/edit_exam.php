...
if(Input::exists()){
	if(Token::check(Input::get('token'))){
		...
		$check_approval = $db->action('SELECT *', 'subject', array('id', '=', '$subject_id'), array('AND', 'approved', '=', '1'))->count();
		if ($check_approval) {
			$validate->add_error('Exam has been Approved, Therefore cannot be modified');
		}
...
?>
							...
							<div class="section_div">
								...
								<select class="form-control section" id="section" name="ssection" >
