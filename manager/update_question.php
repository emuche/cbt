...
<?php } ?>
	...
	<form action="" method="post" class="form-horizontal" enctype="multipart/form-data" role="form">
		...
		<div>
			...
			<textarea name="question" id="question" class="form-control" rows="10" placeholder="Enter question here" readonly=""><?php echo $question->question;?></textarea>	
			<br>	
		</div>
		<br>
		<br>
		<div>
			<div class="col-md-12 text-center"><label for="option">Options of the Question</label></div>
			<div class="row">
				<div class="col-md-10">Make sure atleast one of the Options is selected as the correct answer</div>
...
<?php
 ...
 ?>
			<div class="row option"><div class="col-md-10"><input type="text" name="option[]" id="option" class="form-control" value="<?php echo $answer->answer;?>" placeholder="Add an option to select in the question" readonly></div><div class="col-md-2"><input type="hidden" name="correct[]" value="<?php if($answer->correct){echo '1';}else{ echo '0';}?>" id="correct" class="correct"><input type="checkbox" id="checkbox_select" class="checkbox_select" <?php if ($answer->correct) { echo 'checked';}?> ></div><br><br></div>
...
?>
		...
		<div class="row col-md-9 divCenter">
			<div class="col-md-4 divCenter"><a href="question_list.php" class="btn btn-warning">BackTo questions</a></div>
		</div>
