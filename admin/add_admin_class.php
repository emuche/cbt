...
<title>Add Admin Personel</title>
	...
	if(Token::check(Input::get('token'))){
		...
		if($validation->passed()){
			...
			try{
				...
				Session::flash('admin_list', 'admin Added Successfully');
...
?>
						...
						<div class="admin_department_div">
							<label for="admin_department">admin Department</label>
								<input type="text" name="admin_department" class="form-control admin_department" id="admin_department" value="<?php echo Input::get('admin_department')?>">
						</div>
						<br>
