	...
	if(Token::check(Input::get('token'))){
		...
		if($validation->passed()){
			...
			try{
				...
				$db->update_table('teachers', array('user_id', '=', $teachers_id), array(
				...
				Session::flash('teachers_list', 'Teacher Updated Successfully');
...
?>
						...
						<div class="post_held_div">
							<label for="post_held">Post Held by Teachers</label>
								<input type="text" name="post_held" class="form-control post_held" id="post_held" value="<?php echo $post = Input::get('post_held') ? Input::get('post_held') : $teachers_dept_info->post_held;?>">
						</div>
						<br>
						<div class="teachers_department_div">
							<label for="teachers_department">Teacher Department</label>
								<input type="text" name="teachers_department" class="form-control teachers_department" id="teachers_department" value="<?php echo $post = Input::get('teachers_department') ? Input::get('teachers_department') : $teachers_dept_info->dept;?>">
						</div>
						<br>
