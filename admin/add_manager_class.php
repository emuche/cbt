...
<title>Add manager Personel</title>
	...
	if(Token::check(Input::get('token'))){
		...
		if($validation->passed()){
			...
			try{
				...
				Session::flash('manager_list', 'Manager Added Successfully');
...
?>
						...
						<div class="manager_department_div">
							<label for="manager_department">Manager Department</label>
								<input type="text" name="manager_department" class="form-control manager_department" id="manager_department" value="<?php echo Input::get('manager_department')?>">
						</div>
						<br>
